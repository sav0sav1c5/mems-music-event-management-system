...
//// Database seeding - Performer Communication
...
//        await MusicEventManagementSystem.Infrastructure.Database.Seeders.PerformerCommunicationSeeder.SeedAsync(context);
//    }
//    catch (Exception ex)
//    {
//        var logger = scope.ServiceProvider.GetRequiredService<ILogger<Program>>();
//        logger.LogError(ex, "An error occurred while seeding Performer Communication data.");
//    }
//}
