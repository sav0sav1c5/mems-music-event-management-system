  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <button className="bg-orange-500 hover:bg-orange-600 px-4 py-2 rounded-xl text-sm transition-colors flex items-center gap-2 text-black font-medium">
      ...
      {/* Error Message */}
      {error && (
        <div className="bg-red-900/20 border border-red-500/30 text-red-200 p-4 rounded-xl">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {featuredEvents.map((event) => (
              <Card key={event.id} hover={true} className="p-4">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-white font-medium text-base">{event.name}</h4>
